"""
Django settings for restless_sky_dev_57252 project.
...
ROOT_URLCONF = 'restless_sky_dev_57252.urls'
...
WSGI_APPLICATION = 'restless_sky_dev_57252.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_sky_dev_57252 API",
    "DESCRIPTION": "API documentation for restless_sky_dev_57252 App",
    "VERSION": "v1",
}
